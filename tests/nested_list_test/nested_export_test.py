...
class CsvExportNestedListTests(unittest.TestCase):
    """
    ...
    def test_csv_export_bank_account_example(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "bank-account-process.csv")
    ...
    def test_csv_export_checkin_process_example(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "checkin-process.csv")
    ...
    def test_csv_export_credit_process_example(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "credit-process.csv")
    ...
    def test_csv_export_order_processing_example(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "order-processing.csv")
    ...
    def test_csv_export_pizza_order_example(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "pizza-order.csv")
    ...
    def test_csv_export_tram_process_example(self):
        ...
        #bpmn_graph.export_nested_file(self.output_directory, "tram-process.csv")
    ...
    def test_csv_export_manual_simple_diagram(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "simple_diagram.csv")
    ...
    def test_csv_export_diagram_with_exclusive_parallel_gateway(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "exclusive_parallel_gateways_diagram.csv")
    ...
    def test_csv_export_diagram_with_inclusive_parallel_gateway(self):
        ...
        bpmn_graph.export_nested_file(self.output_directory, "inclusive_parallel_gateways_diagram.csv")
